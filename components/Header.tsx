    ...
    <header className="header">
      <div className="header__left">
        <Link href="/" className="header__logo">
          <Image src="/images/logo/PixelGamezLogoTextNoBackround.png" alt="PixelGamez Logo" width={300} height={64} className="header__logo-icon" priority style={{ width: 'auto', height: '64px' }} unoptimized />
        </Link>
      </div>
